...
state=Indonesia
locality=Indonesia
organization=GeoGabut
organizationalunit=GeoGabut
commonname=GeoGabut
...
wget -O /etc/accel-ppp.conf "https://github.com/ikelirawanrepo/AutoInstall/raw/main/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://github.com/ikelirawanrepo/AutoInstall/raw/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://github.com/ikelirawanrepo/AutoInstall/raw/main/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://github.com/ikelirawanrepo/AutoInstall/raw/main/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://github.com/ikelirawanrepo/AutoInstall/raw/main/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
