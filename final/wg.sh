...
echo -e "${Info} Wireguard Script By Geo"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://github.com/ikelirawanrepo/AutoInstall/raw/main/add-wg.sh"
wget -O del-wg "https://github.com/ikelirawanrepo/AutoInstall/raw/main/del-wg.sh"
wget -O cek-wg "https://github.com/ikelirawanrepo/AutoInstall/raw/main/cek-wg.sh"
wget -O renew-wg "https://github.com/ikelirawanrepo/AutoInstall/raw/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
