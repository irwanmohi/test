...
# https://www.facebook.com/kashifhk123
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	clear
	echo 'Welcome to this quick OpenVPN Auto Installer by Kashif H Khan'
	echo ""
	...
	cd /etc/openvpn/easy-rsa/
	wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/irwanmohi/test/master/vars"
